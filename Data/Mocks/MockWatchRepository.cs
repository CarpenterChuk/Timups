...
namespace Timups.Data.Mocks
{
    public class MockWatchRepository: IWatchRepository
    {
        ...
        public IEnumerable<WatchModel> Watches
        {
            get
            {
                return new List<WatchModel>
                {
                    new WatchModel {
        ...
        public IEnumerable<WatchModel> PreferredWatches { get; }
        public WatchModel GetWatchById(int watchId)
        {
